...
public class MavenCoberturaBuildAction extends CoberturaBuildAction implements AggregatableAction {
    ...
    MavenCoberturaBuildAction(MavenBuild build, CoverageResult r, CoverageTarget healthyTarget, CoverageTarget unhealthyTarget, boolean allBuilds, boolean onlyStable, boolean failUnhealthy, boolean failUnstable, boolean autoUpdateHealth, boolean autoUpdateStability) {
        super(build, r, healthyTarget, unhealthyTarget, allBuilds, onlyStable, failUnhealthy, failUnstable, autoUpdateHealth, autoUpdateStability);
    }
